...
void exp_sequential_1(void)
{
    printf("Experimenting sequential scheduling 1 ...\n");
...
//    z3::expr lhs(!x || y);
	...
	*/
    ...
    printf("Experimenting sequential scheduling 1 ... finished\n");    
}
...
void generate_random_complex_objects(void)
{
    ...
    #ifdef VERBOSE
    {
	printf("Generating random object ...\n");
    }
    #endif
	...
	#ifdef VERBOSE
	{
	    printf("  O %d: w:%d h:%d d:%d ", i, complex_Obj_widths[i], complex_Obj_heights[i], complex_Obj_durations[i]);
	}
	#endif
...
void exp_sequential_2(void)
{
    clock_t start, finish;
    
    printf("Experimenting sequential scheduling 2 ...\n");
...
//	z_solver.add(T_schedules[i] >= 0 && T_schedules[i] + complex_Obj_durations[i] <= complex_time_resolution);
	...
	*/
    ...
    printf("Experimenting sequential scheduling 2 ... finished\n");    
}


const int complex_max_rotation = 8;

int rotated_Obj_widths[max_complex_Obj_count][complex_max_rotation];
int rotated_Obj_heights[max_complex_Obj_count][complex_max_rotation];
...
void exp_sequential_3(void)
{
    clock_t start, finish;
    
    printf("Experimenting sequential scheduling 3 ...\n");
	...
	*/
    ...
    printf("Time: %.3f\n", (finish - start) / (double)CLOCKS_PER_SEC);
    printf("Experimenting sequential scheduling 3 ... finished\n");    
}
...
void exp_sequential_4(void)
{ 
    clock_t start, finish;
    
    printf("Experimenting sequential 4 ...\n");
    ...
    */
    ...
    SVG preview_svg("sequential_exp_4.svg");
    ...
    printf("Time: %.3f\n", (finish - start) / (double)CLOCKS_PER_SEC);
    printf("Experimenting sequential 4 ... finished\n");    
}


void exp_sequential_5(void)
{ 
    clock_t start, finish;
    
    printf("Experimenting sequential 5 ...\n");
    ...
    */
    ...
    SVG preview_svg("sequential_exp_5.svg");
    ...
    printf("Time: %.3f\n", (finish - start) / (double)CLOCKS_PER_SEC);
    printf("Experimenting sequential 5 ... finished\n");    
}



void exp_sequential_6(void)
{ 
    clock_t start, finish;
    
    printf("Experimenting polygon 6 ...\n");
...
*/
	...
	*/
	...
	if (optimized)
	{
	    ...
	    SVG preview_svg("sequential_exp_6.svg");
    ...
    printf("Time: %.3f\n", (finish - start) / (double)CLOCKS_PER_SEC);
    printf("Experimenting sequential 6 ... finished\n");    
}


void exp_sequential_7(void)
{ 
    clock_t start, finish;
    
    printf("Experimenting polygon 7 ...\n");
...
*/
    ...
    */    
	...
	if (optimized)
	{
	    ...
	    SVG preview_svg("sequential_exp_7.svg");
    ...
    printf("Time: %.3f\n", (finish - start) / (double)CLOCKS_PER_SEC);
    printf("Experimenting sequential 7 ... finished\n");    
}
...
void exp_sequential_8(void)
{
    #ifdef VERBOSE
    {
	printf("Experimenting sequential scheduling 8 ...\n");
    }
    #endif
    ...
    */
    ...
    #ifdef VERBOSE
    {
	printf("Experimenting sequential scheduling 8 ... finished\n");
    }
    #endif
}
