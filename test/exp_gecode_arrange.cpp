...
#include "exp_gecode_arrange.hpp"
...
void exp_arrangement_1(void)
{
    printf("Experimenting sheet arrangement 1 ...\n");
    ...
    printf("Experimenting sheet arrangement 1 ... finished\n");    
}
...
int complex_sheet_resolution_max = 250;

int complex_time_resolution = 1000;
int complex_height_threshold = 25;

int complex_Obj_count = 10;
const int max_complex_Obj_count = 32;

int complex_Obj_widths[max_complex_Obj_count];
int complex_Obj_heights[max_complex_Obj_count];
int complex_Obj_durations[max_complex_Obj_count];
...
public:
    ...
    IntVar complex_Obj_x[max_complex_Obj_count];
    IntVar complex_Obj_y[max_complex_Obj_count];
    IntVar complex_Obj_t[max_complex_Obj_count];

    IntVar gantry_left_y[max_complex_Obj_count];
    IntVar gantry_right_y[max_complex_Obj_count];        
...
int complex_sheet_resolution_X = 250;

int complex_sheet_resolution_X_min = 10;
int complex_sheet_resolution_X_max = 250;


int complex_sheet_resolution_Y = 210;

int complex_sheet_resolution_Y_min = 10;
int complex_sheet_resolution_Y_max = 210;
...
void generate_random_complex_objects(void)
{
    ...
    #ifdef VERBOSE
    {
	printf("Generating random objects ...\n");
    }
    #endif
    for (int i = 0; i < complex_Obj_count; ++i)
    {
	...
	#ifdef VERBOSE
	{
	    printf("  Random object [%d]: x_size: %d, y_size:%d, height: %d ", i, complex_Obj_widths[i], complex_Obj_heights[i], complex_Obj_durations[i]);
...
void exp_arrangement_2(void)
{ 
    printf("Experimenting sheet arrangement 2 ...\n");
    ...
    printf("Experimenting sheet arrangement 2 ... finished\n");
}


void exp_arrangement_3(void)
{ 
    printf("Experimenting sheet arrangement 3 ...\n");
    ...
    printf("Experimenting sheet arrangement 3 ... finished\n");
}


void exp_arrangement_4(void)
{ 
    printf("Experimenting sheet arrangement 4 ...\n");
    ...
    printf("Experimenting sheet arrangement 4 ... finished\n");
}


void exp_arrangement_5(void)
{ 
    printf("Experimenting sheet arrangement 5 ...\n");
    ...
    if (ComplexSequentialProblem *sequential_P = engine.next())	
    {
	sequential_P->print();
	clock_t end = clock();
    ...
    printf("Experimenting sheet arrangement 5 ... finished\n");
}


void exp_arrangement_6(void)
{ 
    printf("Experimenting sheet arrangement 6 ...\n");
    generate_random_complex_objects();
	...
	*/
    ...
    printf("Experimenting sheet arrangement 6 ... finished\n");
}


void exp_arrangement_7(void)
{ 
    printf("Experimenting sheet arrangement 7 ...\n");
    generate_random_complex_objects();    
	...
	*/
    ...
    printf("Experimenting sheet arrangement 7 ... finished\n");
}


const int EXP_MAX_COMPLEX_OBJECTS = 32;
const int EXP_ATTEMPTS_PER_COUNT = 10;

void exp_arrangement_8(void)
{
    #ifdef VERBOSE
    {    
	printf("Experimenting sheet arrangement 8 ...\n");
    }
    #endif

    for (complex_Obj_count = 1; complex_Obj_count <= EXP_MAX_COMPLEX_OBJECTS; ++complex_Obj_count)
    {
	for (int attempt = 0; attempt < EXP_ATTEMPTS_PER_COUNT; ++attempt)
	{
	    printf("%d\t%d\t", complex_Obj_count, attempt);
	    ...
	    options.nogoods_limit = 16 * 512;
	    */
	    options.stop = Search::Stop::time(8000);
    ...
    #ifdef VERBOSE
    {
	printf("Experimenting sheet arrangement 8 ... finished\n");
    }
    #endif
}
