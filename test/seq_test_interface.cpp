...
{ 
    ...
    std::vector<ObjectToPrint> objects_to_print = load_exported_data_from_file("arrange_data_export.txt");
...
{ 
    ...
    if (load_printer_geometry_from_file("printer_geometry.mk4.txt", printer_geometry) != 0)
    {
...
int test_interface_4(void)
{
    ...
    int result = load_printer_geometry_from_file("../printers/printer_geometry.mk4.compatibility.txt", printer_geometry);
